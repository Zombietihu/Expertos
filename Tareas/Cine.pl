...
/* Base de Conocimiento
    ...
    movie(M, Y) <- película M realizada en el año Y
    director(M, D) <- película M dirigida por el director D
    actor(M, A, R) <- actor A personificando a R en la película M
    actress(M, A, R) <- actriz A personificando a R la película M
...
movie(american_beauty, 1999,norteamericana).
...
gano_Oscar(american_beauty,si).

movie(anna, 1987,norteamericana).
...
movie(barton_fink, 1991,norteamericana).
...
movie(the_big_lebowski, 1998,norteamericana).
...
movie(blade_runner, 1997,norteamericana).
...
movie(blood_simple, 1984,norteamericana).
...
movie(the_cotton_club, 1984,norteamericana).
...
movie(crimewave, 1985,norteamericana).
...
movie(down_from_the_mountain, 2000,norteamericana).
...
movie(fargo, 1996,norteamericana).
...
movie(the_firm, 1993,norteamericana).
...
movie(frankenweenie, 1984,norteamericana).
...
movie(ghost_busters, 1984,norteamericana).
...
movie(girl_with_a_pearl_earring, 2003,norteamericana).
...
movie(the_godfather, 1972,norteamericana).
...
gano_Oscar(the_godfather,si).

movie(the_godfather_part_ii, 1974,norteamericana).
...
gano_Oscar(the_godfather_part_ii,si).

movie(the_godfather_part_iii, 1990,norteamericana).
...
movie(groundhog_day, 1993,norteamericana).
...
movie(hail_caesar, 2006,norteamericana).
director(hail_caesar, ethan_coen).
director(hail_caesar, joel_coen).

movie(hearts_of_darkness_a_filmmaker_s_apocalypse, 1991,norteamericana).
...
movie(the_hudsucker_proxy, 1994,norteamericana).
...
movie(star_wars_episode_i__the_phantom_menace, 1999,norteamericana).
...
movie(the_usual_suspects, 1995,norteamericana).
...
movie(untitled_woody_allen_fall_project_2006, 2006,norteamericana).
...
movie(a_view_from_the_bridge, 2006,norteamericana).
actress(a_view_from_the_bridge, scarlett_johansson, catherine).
actor(a_view_from_the_bridge, anthony_lapaglia, eddie_carbone).

/*Aqui va todo lo de la tarea
 movie(M, Y, P) <- película M realizada en el año de nacinalidad P
    director(M, D) <- película M dirigida por el director D
    actor(M, A, R,N) <- actor A personificando a R en la película M
    actress(M, A, R.N) <- actriz A personificando a R la película M*/
/**/

movie(from_dusk_till_dawn,1996,norteamericana).
director(from_dusk_till_dawn,robert_rodriguez).
actor(from_dusk_till_dawn,harvey_keitel,jacob,estadounidense).
actor(from_dusk_till_dawn,george_clooney,seth_gecko,estadounidense).
actor(from_dusk_till_dawn,quentin_tarantino,richard_gecko,estadounidense).
actress(from_dusk_till_dawn,juliette_lewis,kate,estadounidense).
actress(from_dusk_till_dawn,salma_hayek,bailarina,mexicano).
gano_Oscar(from_dusk_till_dawn,no).
genero(from_dusk_till_dawn,terror).

movie(the_terminal,2004,norteamericana).
director(the_terminal,steven_spielberg).
actor(the_terminal,tom_hanks,viktor_navorski,estadounidense).
actor(the_terminal,stanley_tucci, frank_dixon,estadounidense).
actor(the_terminal,diego_luna,enrrique_cruz,mexicano).
actress(the_terminal,catherine_zeta_jones,amelia_warren,britanica).
actress(the_terminal,zoe_saldaña,agente_dolores,estadounidense).
gano_Oscar(the_terminal,no).
genero(the_terminal,comedia).

movie(jack_and_jill,2011,norteamericana).
director(jack_and_jill,dennis_dungan).
actor(jack_and_jill,adam_sandler,jack_y_jill,estadounidense).
actor(jack_and_jill,al_pacino,al_pacino,estadounidense).
actor(jack_and_jill,eugenio_derbez,felipe,mexicano).
actress(jack_and_jill,katie_holmes,erin_sadelstein,estadounidense).
gano_Oscar(jack_and_jill,no).
genero(jack_and_jill,comedia).

movie(birdman,2014,norteamericana).
director(birdman,alejandro_g_iñarritu).
actor(birdman,michael_keaton,riggan_thomson,estadounidense).
actor(birdman,edwar_norton,mike_shiner,estadounidense).
actor(birdman,zach_galifianakis, jeke_el_abigado,estadounidense).
actress(birdman,naomi_watts,lesley,estadounidense).
actress(birdman,emma_stone, sam_thomson,estadounidense).
gano_Oscar(birdman,si).
genero(birdman,drama).

movie(argo,2012,norteamericana).
director(argo,ben_affleck).
actor(argo,ben_affleck,agente_cia,estadounidense).
actor(argo,bryan_cranston,director_cia,estadounidense).
actor(argo,alan_arkin,'',estadounidense).
actor(argo,john_goodman,'',estadounidense).
gano_Oscar(argo,si).
genero(argo,drama).

movie(nosotros_los_nobles,2013, méxico).
director(nosotros_los_nobles, gaz_alazraki).
actor(nosotros_los_nobles,gonzalo_vega, germán_noble,mexicano).
actor(nosotros_los_nobles,luis_gerardo_mendéz, javier_noble,mexicano).
actor(nosotros_los_nobles,juan_pablo_gil, charlie_noble,mexicano).
actor(nosotros_los_nobles,ianis_guerrero, lucho,mexicano).
actor(nosotros_los_nobles,carlos_gascón, pedro_pintado,mexicano).
actor(nosotros_los_nobles,quezali_cortés, gilberto_marín,mexicano).
actor(nosotros_los_nobles,mario_haddad, anwar_karim,mexicano).
actor(nosotros_los_nobles,alberto_zeni, juan_pablo,mexicano).
actor(nosotros_los_nobles,carlos_alazraki, el_director_de_la_carrera,mexicano).
actor(nosotros_los_nobles,gary_alazraki, santiago,mexicano).
actress(nosotros_los_nobles,karla_souza, bárbara_noble,mexicano).
actress(nosotros_los_nobles,mary_paz_mata, margarita_la_nana,mexicano).
actress(nosotros_los_nobles,ana_karina_guevara, carmen_solórzano,mexicano).
actress(nosotros_los_nobles,marell_cano,danny,mexicano).
actress(nosotros_los_nobles,mariana_braun, maestra_lucía,mexicano).
gano_Oscar(nosotros_los_nobles,no).
genero(nosotros_los_nobles,comedia).

movie(el_crimen_del_padre_amaro,2002,méxico).
director(el_crimen_del_padre_amaro,carlos_carrera).
actor(el_crimen_del_padre_amaro,gael_garcía_Bernal, padre_amaro,mexicano).
actor(el_crimen_del_padre_amaro,sancho_gracia, padre_benito_díaz,mexicano).
actor(el_crimen_del_padre_amaro,ernesto_gómez_cruz,el_obispo,mexicano).
actor(el_crimen_del_padre_amaro,gastón_melo, martín,mexicano).
actor(el_crimen_del_padre_amaro,damián_alcázar, padre_natalio_pérez,mexicano).
actor(el_crimen_del_padre_amaro,andrés_montiel, rubén_de_la_rosa,mexicano).
actor(el_crimen_del_padre_amaro,pedro_armendáriz_jr, el_presidente_municipal,mexicano).
actress(el_crimen_del_padre_amaro,ana_claudia_talancón, amelia,mexicano).
actress(el_crimen_del_padre_amaro,luisa_huertas, dionisia,mexicano).
actress(el_crimen_del_padre_amaro,angélica_aragón, augustina_sanjuanera,mexicano).
gano_Oscar(el_crimen_del_padre_amaro,no).
genero(el_crimen_del_padre_amaro,drama).


movie(no_eres_tu_soy_yo,2010,méxico).
director(no_eres_tu_soy_yo,alejandro_springall)
actor(no_eres_tu_soy_yo,eugenio_derbez, javier_herrera,mexicano).
actor(no_eres_tu_soy_yo,juan_ríos_cantú, martín,mexicano).
actor(no_eres_tu_soy_yo,alberto_estrella, dr_carlos,mexicano).
actress(no_eres_tu_soy_yo,alejandra_barros, maría,mexicano).
actress(no_eres_tu_soy_yo,martina_garcía, julia,mexicano).
gano_Oscar(no_eres_tu_soy_yo,no,mexicano).
genero(no_eres_tu_soy_yo,comedia,mexicano).

movie(km_31,2007,méxico).
director(km_31,ricardo_alvarez_canales)
actor(km_31,raul_mendez,omar,mexicano).
actor(km_31,adria_collado, nuño,mexicano).
actress(km_31,iliana_fox,agata_catalina,mexicano).
actress(km_31,luisa_huertas, anciana,mexicano).
actress(km_31,marcela_pezet,la_llorona,mexicano).
gano_Oscar(km_31,no).
genero(km_31,terror).

movie(profanadores_de_tumbas,1966,méxico).
director(profanadores_de_tumbas,jose_diaz_morales)
actor(profanadores_de_tumbas,gina_romand,cientifico_loco,mexicano).
actor(profanadores_de_tumbas,jorge_peral,lobo_negro,mexicano).
actor(profanadores_de_tumbas,mario_orea,fernando_oses,mexicano).
actor(profanadores_de_tumbas,santo, santo,mexicano).
gano_Oscar(profanadores_de_tumbas,no).
genero(profanadores_de_tumbas,terror).

movie(el_callejón_de_los_milagros,1995,méxico).
director(el_callejón_de_los_milagros, jorge_fonts).
actor(el_callejón_de_los_milagros,ernesto_gómez_cruz,'',mexicano).
actor(el_callejón_de_los_milagros,daniel_giménez_cacho,'',mexicano).
actor(el_callejón_de_los_milagros,claudio_obregon,'',mexicano).
actor(el_callejón_de_los_milagros,bruno_bichir,'',mexicano).
actress(el_callejón_de_los_milagros,maría_rojo,'',mexicano).
actress(el_callejón_de_los_milagros,salma_hayek,'',mexicano).
actress(el_callejón_de_los_milagros,delia_casanova,'',mexicano).
gano_Oscar(el_callejón_de_los_milagros,no).
genero(el_callejón_de_los_milagros,drama).

movie(rudo_y_cursi,2008,méxico).
director(rudo_y_cursi,carlos_cuaron).
actor(rudo_y_cursi,guillermo_francella, darío_batuta_vidali,argentino).
actor(rudo_y_cursi,gael_garcía_bernal, tato_cursi_verdusco,mexicano).
actor(rudo_y_cursi,diego_luna, beto_rudo_verdusco,mexicano).
actress(rudo_y_cursi,jessica_mass, maya_vega,mexicano).
actress(rudo_y_cursi,dolores_heredia, doña_elvira,mexicano).
no_Oscar(rudo_y_cursi,no).
genero(rudo_y_cursi,comedia).

movie(les_choristes,2004,francia).
director(les_choristes,	christophe_barratier).
actor(les_choristes,gédard_jugnot,clément_mathieu,frances).
actor(les_choristes,françois_berléand, rachin,frances).
actor(les_choristes,kad_merad, chabert,frances).
actor(les_choristes,jean_paul_bonnaire, maxence,frances).
actor(les_choristes,jean_baptiste_maunier ,pierre_morhange,frances).
actor(les_choristes,marie_bunelle, violette_morhange,frances).
gano_Oscar(les_choristes,no).
genero(les_choristes,musical).

movie(amélie,2001,francia).
director(amélie,jean_pierre_jeunet).
actress(amélie,audrey_tautou,amélie,frances).
actress(amélie,mathieu_kassovitz,'',frances).
actress(amélie,isabelle_nanty,'',frances).
actor(amélie,Rufus,'',frances).
gano_Oscar(amélie,no).
genero(amélie,comedia).

movie(amour,2012,francia).
director(amour,michael_haneke).
actor(amour,jean_louis_trintignat,georges,frances).
actor(amour,emmanuelle_riva,anne,frances).
actress(amour,isabelle_huppert,eva,frances).
gano_Oscar(amour,no).
genero(amour,drama).

movie(intouchables,2011,francia).
director(intouchables,oliver_nakache).
actor(intouchables,françois_cluzet,'',frances).
actor(intouchables,omar_sy,'',frances).
gano_Oscar(intouchables,no).
genero(intouchables,comedia).

movie(la_vie_en_rose,2007,francia).
director(la_vie_en_rose,oliver_dahan).
actor(la_vie_en_rose,jean_piegrre_martins, marcel_cerdan,frances).
actor(la_vie_en_rose,gérard_depardieu, louis_leplée,frances).
actor(la_vie_en_rose,jean_paul_rouve, louis_gassion,frances).
actress(la_vie_en_rose,marion_cotillard, édith_piaf,frances).
actress(la_vie_en_rose,clotilde_courau, annetta_maillard,frances).
actress(la_vie_en_rose,sylvie_testud,mômone,frances).



/*Peliculas que ganarón el oscar*/
/*Peliculas NorteAmericanas,Mexicanas,Francesas*/
es_de(M,P):- movie(M,X,P).
/*actress-actor mexicano en peliculas extranjeras*/
actores_mexicanos(P,A):-actor(P,A,_,mexicano),movie(P,_,norteamericana).
actores_mexicanos(P,A):-actress(P,A,_,mexicano),movie(P,_,norteamericana).